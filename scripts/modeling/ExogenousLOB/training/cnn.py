from Models.ConvolutionalModels.ExogenousLobConvolve import ExogenousLobConvolve
...
def run_training(model, epochs, lr, sequence_size, name):
    ...
    results = f'results/ExogenousLOB/params/{name}'
    ...
    # Create tester
    tester = WalkForwardTester(model, train_manager, train_manager, sequence_size=sequence_size, use_trading=False, use_exogenous=True)
