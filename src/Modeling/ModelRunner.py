...
class ModelRunner:
    ...
    def get_datasets(self, sequence_size: int, use_trading: bool, use_exogenous: bool) -> DatasetTuple:
        """
        ...
        train_dataset = filter_features(train_dataset, sequence_size, use_trading, use_exogenous)
        validation_dataset = filter_features(validation_dataset, sequence_size, use_trading, use_exogenous)
        test_dataset = filter_features(test_dataset, sequence_size, use_trading, use_exogenous)

        return train_dataset, validation_dataset, test_dataset

    def train(self, epochs: int, learning_rate: float, verbose: bool=False) -> None:
        """
        ...
        # Train the model
        train_model(self.model, train_dataset, validation_dataset, epochs, learning_rate, verbose)
...
def filter_features(dataset: list[BaseSampleTuple],
                    sequence_size: int, use_trading: bool, use_exogenous: bool) -> list[BaseSampleTuple]:
    """
...
def train_model(model: BaseModel, train_dataset: list[BaseSampleTuple], validation_dataset: list[BaseSampleTuple],
                epochs: int, learning_rate: float, verbose=False) -> None:
    """
